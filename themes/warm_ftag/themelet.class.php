...
class Themelet extends BaseThemelet {
	public function build_thumb_html(Image $image) {
		...
		return "<div class='thumb shm-thumb'>".
		       ...
		       "		<img id='thumb_$i_id' title='$h_tip' alt='$h_tip' height='{$tsize[1]}' width='{$tsize[0]}' data-base64='{$h_thumb_link}' src='data:image/jpeg;base64,'>".
		       "	</a>".
			   "	<div>".
