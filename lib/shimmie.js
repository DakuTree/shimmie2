...
$(document).ready(function() {
	...
	/* Click image list to hide nav temporarily */
	$('#image-list > h3').click(function(){if($('nav').css('display') == 'block'){
		$('nav').animate({width: 'toggle'}, function(){
			$("article").animate({'margin-left':"16px"});
		});
	}else if($('nav').css('display') == 'none'){
		$("article").animate({'margin-left':"226px"}, function(){
